...
@router.get("/logs/{operation_id}", response_model=dict, summary="Get Single Operation Log")
async def get_operation_log(operation_id: str, db: Session = Depends(get_db)):
